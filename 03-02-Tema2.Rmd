...
Si tenemos una serie con estacionalidad y agregamos la serie, obteniendo un dato por año si la serie es mensual o un dato por semana si es diaria, obtenemos una nueva serie sin estacionalidad, solo con _tendencia_. 
