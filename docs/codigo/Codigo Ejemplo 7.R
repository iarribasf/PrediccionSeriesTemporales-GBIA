...
# Transformacion
#----------------------------------------------------------
ggAcf(log(Pernoctacionesb), lag = 48, ylim = c(-1 ,1),
      xlab = "", ylab = "", main = "")

ggAcf(diff(log(Pernoctacionesb)), lag = 48,  ylim = c(-1 ,1),
      xlab = "", ylab = "", main = "")

ggAcf(diff(log(Pernoctacionesb), lag = 12), lag = 48,  ylim = c(-1 ,1),
      xlab = "", ylab = "", main = "")

ggAcf(diff(diff(log(Pernoctacionesb), lag=12)), lag = 48, ylim = c(-1 ,1),
      xlab = "", ylab = "", main = "")
