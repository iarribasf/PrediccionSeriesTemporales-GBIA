...
nacimientos
diff(nacimientos)
diff(nacimientos, lag = 12)
diff(diff(nacimientos, lag = 12))
...
X <- data.frame(cbind(DiasMes, SemanaSanta, d1206, d12100111, d0416, d1120, d1122, l12200221))
